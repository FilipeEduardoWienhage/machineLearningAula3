...
acurariaCLF = accuracy_score(y_test, y_predclf)
...
print("A acuracia CLF Tree é: ", acurariaCLF)
...
previsaoCLF = clf.predict(novo_email_vetorizado)
print('Predição do novo e-mail usando CLF é: ', previsaoCLF)